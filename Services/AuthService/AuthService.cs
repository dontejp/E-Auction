...
namespace E_Auction.Services.AuthService
{
    public class AuthService : IAuthService
    {
        ...
        private readonly IConfiguration _configuration;                                                     //used for creating the token
        ...
        public async Task<ServiceResponse<string>> Login(string username, string password)
        {
            ...
            User user = await _context.Users                                                                 //searching the database Users table for the first person that shows up as the given username...
